...
class PersonController extends Controller
{
    ...
    function post(Request $data)
    {
       try{
          ...
          $person->phone_number = $result['phone_number'];
          $person->mobile_number = $result['mobile_number'];
          $person->home_address = $result['home_address'];
          $person->work_address = $result['work_address'];
          $person->email = $result['email'];
          $person->gender_id = $result['gender_id'];
          $person->save();
          DB::commit();
       } catch (Exception $e) {
